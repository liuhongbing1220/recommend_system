...
class Model(object):
    ...
    def __init__(self, user_count, item_count, cate_count, cate_list, predict_batch_size, predict_ads_num, is_train=True):
        ...
        hist_i = tf.reshape(hist_i, [-1, hidden_units], name='hist_bn') # B*H
    ...
    (u, i, y, hist_i, sl)
    uij[0] = u userId
    uji[1] = i target_ad_id
    uij[2] = y label 0 or 1
    uij[3] = hist_i
    sl: maxlength
    '''
